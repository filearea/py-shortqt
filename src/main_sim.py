...
from config.settings import (
    BINANCE_WS_URL, SYMBOL, ACTUAL_LEVERAGE, INITIAL_BALANCE,
...
class TradingBot:
    ...
    async def run(self):
        ...
        print("=" * 70)
        print(f"初始保证金：{INITIAL_BALANCE} USDT | 杠杆：{ACTUAL_LEVERAGE}x")
